...
const ABOUT_HERO = landscapeGallery[4];
const ABOUT_MISSION = landscapeGallery[5];
const ABOUT_VISION = landscapeGallery[7];
      ...
      <section className="section section-alt">
        <div className="container">
          <div className={styles.missionGrid}>
            ...
            <ScrollReveal className={styles.missionImageCol} delay={0.2}>
              <div className={styles.missionImageFrame}>
                <Image
                  src={ABOUT_MISSION.src}
                  alt={ABOUT_MISSION.alt}
                  fill
      ...
      <section className={`section ${styles.visionSection}`}>
        <div className="container">
          <div className={styles.visionLayout}>
            <ScrollReveal className={styles.visionImageCol}>
              <div className={styles.visionImageFrame}>
                <Image
                  src={ABOUT_VISION.src}
                  alt="Tem Motorrs Vision"
                  fill
            ...
            <ScrollReveal className={styles.visionTextCol} delay={0.15}>
