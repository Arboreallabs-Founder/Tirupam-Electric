...
export default function sitemap() {
  ...
  return [
    ...
    { url: `${base}/about`,        lastModified: "2026-06-16", changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/contact`,      lastModified: "2026-06-16", changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/investors`,    lastModified: "2026-06-16", changeFrequency: "monthly", priority: 0.7 },
  ];
}
